...
export default function App() {
  ...
  return (
    ...
    <ImageBackground source={require('../Images/bg-image.jpg')} blurRadius = {7} style={styles.bgImage}>
        ...
        <Text style={{color: 'white', textAlign: 'center', marginTop: 30}}>Don't have an account?</Text>
        <TouchableOpacity onPress={() => navigation.navigate('Register')} style={{marginTop: 15, backgroundColor: 'rgba(255,255,255,0.4)',height: 45, width: 100, borderRadius: 30  , alignSelf: 'center'}}>
            <Text style={{color: 'white', textAlign: 'center', color: 'green', fontWeight: 'bold', padding: 13}}>REGISTER</Text>
        </TouchableOpacity>
        </View>
